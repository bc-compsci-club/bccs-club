      ...
      <div className="mx-auto max-w-2xl py-20 sm:py-24 lg:py-28">
        <div className="text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Explore resources to help you succeed in your tech journey. If you have any resources you would like to share with the BC tech community, we welcome your contributions on our GitHub repository.
          </p>
